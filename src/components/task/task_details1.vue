  ...
  <div class="task_details1">
    ...
    <div class="mint-cell-wrapper mint-content">
      <div class="mint-cell-title">
        <span class="icon-dh spanIcon"><i class="iconfont icon-activity"></i></span>
        <div class="divFloat">
          <span class="mint-cell-text yanse"><span>我发起的任务</span><span class="jingxingzhong">进行中</span></span>
    ...
    <div class="fujian">
      <el-button @click.native="clickReminders" class="cuiban">
        <i class="icon iconfont icon-cuiban"></i> 催办
      </el-button>
      <el-button @click.native="clickDelete" class="shanchu">
        <i class="icon iconfont icon-delete_light"></i> 删除
      </el-button>
    </div>
